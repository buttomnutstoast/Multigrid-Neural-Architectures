...
local initcheck = argcheck{
    pack=true,
    help=[[
        A dataset class for mnist-affine transformation dataset
    ]],
    {name="path",
     type="string",
     help="Path to root directory of mnist-affine transformation"},
...
function dataset:__init(...)
    ...
    -- get dataset
    local filePath = paths.concat(self.path, 'mnist_affine.t7')
