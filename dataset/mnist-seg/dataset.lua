...
local initcheck = argcheck{
    pack=true,
    help=[[
        A dataset class for mnist-segmentations dataset
    ]],
    {name="path",
     type="string",
     help="Path to root directory of mnist-segmentation"},
...
function dataset:__init(...)
    ...
    -- get dataset
    local filePath = paths.concat(self.path, 'mnist_segmentation.t7')
