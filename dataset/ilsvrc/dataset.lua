...
local initcheck = argcheck{
    ...
    {name="forceClasses",
     ...
     help="If you want this loader to map certain classes to certain indices, "
         ...
         .. "This function is very useful when you want two loaders to have the"
         .. " same class indices (trainLoader/testLoader for example)",
     opt = true},
...
function dataset:__init(...)
    ...
    local maxPathLength = tonumber(
        sys.fexecute(wc .. " -L '" .. combinedFindList .. "' |" .. cut .. " -f1 -d' '")) + 1
    ...
    if self.split == 100 then
        ...
        for i=1,#self.classes do
            ...
            local splitidx = math.floor((count * self.split / 100) + 0.5)
