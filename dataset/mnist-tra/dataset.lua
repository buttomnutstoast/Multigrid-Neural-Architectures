...
local initcheck = argcheck{
    pack=true,
    help=[[
        A dataset class for mnist-translation dataset
    ]],
    {name="path",
     type="string",
     help="Path to root directory of mnist-translation"},
...
function dataset:__init(...)
    ...
    -- get dataset
    local filePath = paths.concat(self.path, 'mnist_translation.t7')
